...
class NotionToMarkdownConverter:
    """Converts Notion API JSON objects to Markdown format."""
    ...
    def convert_page(self, notion_data: Dict[str, Any]) -> str:
        ...
        Args:
            notion_data: The Notion API JSON response containing page data
...
def json_to_markdown(json_file_path: str) -> str:
    """
    Convert a Notion JSON file to Markdown.
...
def json_to_markdown_file(json_file_path: str, markdown_file_path: str) -> None:
    """
    Convert a Notion JSON file to a Markdown file.
    
    Args:
        json_file_path: Path to the input JSON file
        markdown_file_path: Path to the output Markdown file
    """
    markdown_content = json_to_markdown(json_file_path)
